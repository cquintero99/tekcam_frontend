...
const ProductList: React.FC<{ filteredProductos: any[], formatCurrency: (value: number) => string }> = ({ filteredProductos, formatCurrency }) => {
      ...
      <div className="grid bg-white p-4 rounded-lg shadow-md grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3  dark:bg-slate-900 dark:border-t dark:border">
        {filteredProductos?.map((producto, index) => (
          ...
          >
            ...
            <div className="p-4">
             <div onClick={() => handleClick(producto.id)}
